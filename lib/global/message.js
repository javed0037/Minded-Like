...
const USER_EXIST = 'User already exists.';
const USERNAME_EXIST = 'Username has already exists.';
...
const OTP_SENT = 'An Password has been sent ON your email,please use password for login.';
...
const INVALID_EMAIL = 'The email you entered is incorrect.';
...
const INVALID_PASSWORD_MESSAGE = 'The old password you entered is incorrect please enter the old password';
const CLIENT_EXIST = 'Client already exists.';
const CLIENT_CREATE = 'Client create successfully';
