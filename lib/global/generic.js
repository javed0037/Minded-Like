...
const serverError = (response = {}, message = BAD_REQUEST_MESSAGE, status = 500) => {
...
let { successResult, verifyData, encodePassword, encodeEmail, serverError, mergeArray, countryCode, generateRandomString, validate, parameterMissing, createUniqueId } = require('../global/generic');
...
const successResult = (response = {}, message = SUCCESS_MESSAGE, status = 200) => {
    if (typeof message == 'string') {
        message = { message }
    }
    message = message[Object.keys(message)[0]];
