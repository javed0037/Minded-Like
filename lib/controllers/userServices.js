...
module.exports = {
 'registration' : (req, res)=>{
	 ...
	 if (data.status) {
      ...
      //var token;
       User.findOne(UserModel, { phoneNumber }).then((result) => {
        if (result) {
              ...
              // if(!data){
                       ...
                       //     } else if (hash){
                              ...
                              //    if(requestObj.firstName && requestObj.lastName && requestObj.phoneNumber && requestObj.email && requestObj.boi && requestObj.gender){
															                            ...
															                            //let user_id = createUniqueId('USER');
                                           ...
                                           //},
                                            ...
                                            //if(message){
                                                 ...
                                                 twilio.sendMessageTwilio(VERIFICATION_MESSAGE + otp, country_code + phoneNumber).then((result) => {
